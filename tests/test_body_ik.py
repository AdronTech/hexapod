...
class TestBodyToLeg:
    ...
    def test_partial_legs(self):
        ...
        subset = {
            Leg.FRONT_RIGHT: neutral_foot_body(Leg.FRONT_RIGHT),
...
class TestBodyPoseIK:
    ...
    def test_pitch_nose_up(self):
        ...
        assert tf_front_pitched > tf_front_flat, (
            "front femur should angle up when nose rises"
        )
        assert tf_rear_pitched < tf_rear_flat, (
            "rear femur should angle down when nose rises"
        )
